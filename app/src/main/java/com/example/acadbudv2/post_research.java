...
public class post_research extends AppCompatActivity {
    private DatabaseReference mPostReference;
    private String userName; // Variable to store the user's name
    private List<String> foulWords;
    private String channelIdentifier = "Research"; // Change this to the desired channel identifier
            ...
            public void onClick(View v) {
                ...
                if (!postText.isEmpty()) {
                    ...
                    if (containsFoulWords(postText)) {
                        // Handle foul words
                        Toast.makeText(post_research.this, "Post contains foul words", Toast.LENGTH_SHORT).show();
                    } else {
                            ...
                            public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
                                ...
                                mPostReference.child(userName).child(postKey).setValue(newPost, new DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                        Toast.makeText(post_research.this, "Post saved successfully", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                    ...
                    Toast.makeText(post_research.this, "Please enter a text", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
