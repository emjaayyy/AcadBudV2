...
public class mapeh_channel extends AppCompatActivity {
    ...
    private String channelIdentifier = "MAPEH";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mapeh_channel);

        Button meeting = findViewById(R.id.meeting_btn_mapeh);
        Button notif = findViewById(R.id.notif_btn_mapeh);
        Button profile = findViewById(R.id.profile_btn_mapeh);
        Button home = findViewById(R.id.home_btn_mapeh);

        meeting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent meet_user = new Intent(mapeh_channel.this, meeting_user.class);
        ...
        notif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bell = new Intent(mapeh_channel.this, notif.class);
                startActivity(bell);
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent me = new Intent(mapeh_channel.this, profile_ssg.class);
                startActivity(me);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(mapeh_channel.this, home_user.class);
                startActivity(back);
            }
        });
        ...
        Button postButton = findViewById(R.id.mapeh_channel_post_btn);
        postButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent write = new Intent(mapeh_channel.this, post_mapeh.class);
                startActivity(write);
            }
