...
public class post_math extends AppCompatActivity {
    ...
    private String channelIdentifier = "Math"; // Change this to the desired channel identifier
            ...
            public void onClick(View v) {
                ...
                if (!postText.isEmpty()) {
                    ...
                    if (containsFoulWords(postText)) {
                        // Handle foul words
                        Toast.makeText(post_math.this, "Post contains foul words", Toast.LENGTH_SHORT).show();
                    } else {
