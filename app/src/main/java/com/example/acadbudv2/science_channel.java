...
public class science_channel extends AppCompatActivity {
    ...
    private String channelIdentifier = "Science";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.science_channel);

        Button meeting = findViewById(R.id.meeting_btn_science);
        Button notif = findViewById(R.id.notif_btn_science);
        Button profile = findViewById(R.id.profile_btn_science);
        Button home = findViewById(R.id.home_btn_science);

        meeting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent meet_user = new Intent(science_channel.this, meeting_user.class);
        ...
        notif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bell = new Intent(science_channel.this, notif.class);
                startActivity(bell);
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent me = new Intent(science_channel.this, profile_ssg.class);
                startActivity(me);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(science_channel.this, home_user.class);
                startActivity(back);
            }
        });
        ...
        recyclerView = findViewById(R.id.recyclerView_science);
        ...
        Button postButton = findViewById(R.id.science_channel_post_btn);
        postButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent write = new Intent(science_channel.this, post_science.class);
                startActivity(write);
            }
