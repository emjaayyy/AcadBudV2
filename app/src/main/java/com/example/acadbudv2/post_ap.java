...
public class post_ap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostReference = FirebaseDatabase.getInstance().getReference("Channels/AP/Posts/lrn"); // Replace "lrn" with your specific database node
                ...
                if (!postText.isEmpty()) {
                    ...
                    mPostReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast.makeText(post_ap.this, "Post saved successfully", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    Toast.makeText(post_ap.this, "Please enter a text", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
