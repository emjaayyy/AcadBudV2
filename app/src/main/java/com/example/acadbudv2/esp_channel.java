...
public class esp_channel extends AppCompatActivity {
    ...
    private String channelIdentifier = "ESP";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button meeting = findViewById(R.id.meeting_btn_esp);
        Button notif = findViewById(R.id.notif_btn_esp);
        Button profile = findViewById(R.id.profile_btn_esp);
        Button home = findViewById(R.id.home_btn_esp);

        meeting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent meet_user = new Intent(esp_channel.this, meeting_user.class);
        ...
        notif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bell = new Intent(esp_channel.this, notif.class);
                startActivity(bell);
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent me = new Intent(esp_channel.this, profile_ssg.class);
                startActivity(me);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(esp_channel.this, home_user.class);
                startActivity(back);
            }
        });
        ...
        recyclerView = findViewById(R.id.recyclerView_esp);
