...
public class innerthoughts_channel extends AppCompatActivity {
    ...
    private String channelIdentifier = "Inner Thoughts";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.innerthoughts_channel);

        Button meeting = findViewById(R.id.meeting_btn_inner_thoughts);
        Button notif = findViewById(R.id.notif_btn_inner_thoughts);
        Button profile = findViewById(R.id.profile_btn_inner_thoughts);
        Button home = findViewById(R.id.home_btn_inner_thoughts);

        meeting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent meet_user = new Intent(innerthoughts_channel.this, meeting_user.class);
        ...
        notif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bell = new Intent(innerthoughts_channel.this, notif.class);
                startActivity(bell);
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent me = new Intent(innerthoughts_channel.this, profile_ssg.class);
                startActivity(me);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(innerthoughts_channel.this, home_user.class);
                startActivity(back);
            }
        });
        ...
        recyclerView = findViewById(R.id.recyclerView_innerthoughts);
        ...
        postButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent write = new Intent(innerthoughts_channel.this, post_innerthoughts.class);
                startActivity(write);
            }
