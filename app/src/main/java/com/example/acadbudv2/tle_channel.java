...
public class tle_channel extends AppCompatActivity {
    ...
    private String channelIdentifier = "TLE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tle_channel);

        Button meeting = findViewById(R.id.meeting_btn_tle);
        Button notif = findViewById(R.id.notif_btn_tle);
        Button profile = findViewById(R.id.profile_btn_tle);
        Button home = findViewById(R.id.home_btn_tle);

        meeting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent meet_user = new Intent(tle_channel.this, meeting_user.class);
        ...
        notif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bell = new Intent(tle_channel.this, notif.class);
                startActivity(bell);
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent me = new Intent(tle_channel.this, profile_ssg.class);
                startActivity(me);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(tle_channel.this, home_user.class);
                startActivity(back);
            }
        });
        ...
        recyclerView = findViewById(R.id.recyclerView_tle);
        ...
        Button postButton = findViewById(R.id.tle_channel_post_btn);
        postButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent write = new Intent(tle_channel.this, post_tle.class);
                startActivity(write);
            }
