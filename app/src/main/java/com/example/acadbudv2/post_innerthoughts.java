...
public class post_innerthoughts extends AppCompatActivity {
    ...
    private String channelIdentifier = "Inner Thoughts"; // Change this to the desired channel identifier
            ...
            public void onClick(View v) {
                ...
                if (!postText.isEmpty()) {
                    ...
                    if (containsFoulWords(postText)) {
                        // Handle foul words
                        Toast.makeText(post_innerthoughts.this, "Post contains foul words", Toast.LENGTH_SHORT).show();
                    } else {
