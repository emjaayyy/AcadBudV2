...
public class post_science extends AppCompatActivity {
    ...
    private String channelIdentifier = "Science"; // Change this to the desired channel identifier
            ...
            public void onClick(View v) {
                ...
                if (!postText.isEmpty()) {
                    ...
                    if (containsFoulWords(postText)) {
                        // Handle foul words
                        Toast.makeText(post_science.this, "Post contains foul words", Toast.LENGTH_SHORT).show();
                    } else {
